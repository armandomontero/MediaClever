...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card-body">
            <form method="POST" action="<?= base_url() ?>archivos/actualizarArchivo" autocomplete="off">
                <?= csrf_field() ?>
                ...
                <div class="form-group mt-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            ...
                            <input required class="form-control text-right" value="<?= $datos->rut_solicitante ?>" id="rut_solicitante" name="rut_solicitante" type="text" />
                        </div>
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <div class="input-group">
                                ...
                                <input required autofocus value="<?= $datos->telefono_solicitante ?>" class="form-control" id="telefono_solicitante" name="telefono_solicitante" type="number" />
                            </div>
                        </div>
                        <div class="col-12 col-sm-3">
                ...
                <div class="form-group mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-2">
                            <label>RUT </label>
                            <input class="form-control text-right" value="<?= $datos->rut_solicitado ?>" id="rut_solicitado" name="rut_solicitado" type="text" />
                        </div>
                        ...
                        <div class="col-12 col-sm-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><img style="padding-right:5px;" width="25" src="<?= base_url() ?>img/chile.png" alt="chile">+56</span>
                                <input required autofocus value="<?= $datos->telefono_solicitado ?>" class="form-control" id="telefono_solicitado" name="telefono_solicitado" type="number" />
                            </div>
                        </div>
                ...
                <div class="form-group mb-4 mt-2">
                    <div class="row ">
                        <div class="col-12 col-sm-6">
                            ...
                            <button id="restaHijo" class="btn btn-danger" type="button"><i class="fas fa-minus"></i> Eliminar Beneficiario</button>
                        </div>
                        <div class="col-12 col-sm-6">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?= base_url() ?>archivo/pendientes" class="btn btn-primary btn-ok"><i class="far fa-folder-open"></i></i> Volver al Archivo</a>
