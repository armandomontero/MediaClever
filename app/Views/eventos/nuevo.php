            ...
            <div class="form-group mb-4 mt-2">
                <div class="row ">
                    <div class="col-12 col-sm-2">
                        ...
                        <input class="form-control" value="<?= $fecha_inicio ?>" id="fecha" name="fecha" type="datetime" />
                    </div>
                    <div class="col-12 col-sm-2">
                        <label>Fecha y Hora de Fin: </label>
                        <input class="form-control" value="<?= $fecha_fin ?>" id="fecha_fin" name="fecha_fin" type="datetime" />
                    </div>
                    <div class="col-12 col-sm-3">
                    ...
                    <div class="col-12 col-sm-2">
                        ...
                        <input class="form-control text-right" value="<?= $config['valor_servicio'] ?>" id="valor" name="valor" type="number" />
                    </div>
