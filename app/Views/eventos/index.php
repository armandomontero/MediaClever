...
<div class="modal fade" id="modal-agenda" tabindex="-1">
    <div class="modal-dialog ">
        <div class="modal-content">
                ...
                <div class="form-group mt-4">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <label for="fecha_start">Fecha y Hr Inicio </label>
                                <input readonly autofocus value="" class="form-control" id="fecha_start" name="fecha_start" type="datetime" />
                            </div>
                            <div class="col-12 col-sm-6">
                                <label for="fecha_end">Fecha y Hr Fin</label>
                                <input readonly class="form-control" value="" id="fecha_end" name="fecha_end" type="datetime" />
                            </div>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button id="agendaMediacion" type="button" class="btn btn-primary" data-dismiss="modal">Mediación</button>
                <button id="agendaServicio" type="button" class="btn btn-primary" data-dismiss="modal">Otro Servicio</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body p-4 pl-4 ml-4 mr-4">
                ...
                <form method="POST" action="<?= base_url() ?>eventos/agendar" autocomplete="off">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="editar" type="button" class="btn btn-primary"><i class="fas fa-pencil"></i> Editar Detalles</button>
...
<script>
 ...
 select: function(start, end) {
                    ...
                    $("#fecha_start").val(fecha_inicio);
                    $("#fecha_end").val(fecha_fin);
    ...
    $("#agendaMediacion").click(function(){
        let fecha_inicio = $("#fecha_start").val();
        let fecha_fin = $("#fecha_end").val();
window.location.href='eventos/nuevo/'+fecha_inicio+'/'+fecha_fin+'/agenda_general';
    });
</script>